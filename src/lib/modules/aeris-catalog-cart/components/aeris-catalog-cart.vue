  ...
  <div data-aeris-catalog-cart>
    <div class="cart-container">
      <div class="cart-panel-trigger">
        ...
        <i :style="{ color: cartColor }" class="fa fa-download" />
      </div>
      ...
      <div class="cart-panel">
        ...
        <ul class="item-list">
          <template v-for="item in this.cartContent" id="cartTemplate">
        ...
        <footer class="cart-panel-footer">
          ...
          <div :v-if="calcFiles" class="total-files-size">
            {{ totalFiles }}<i class="fa fa-file-o" /> ({{ totalFilesSize }})
          </div>
        </footer>
        <!-- cart-panel-footer -->
      </div>
      ...
      <div v-if="isPopupOpen" class="cart-popup">
