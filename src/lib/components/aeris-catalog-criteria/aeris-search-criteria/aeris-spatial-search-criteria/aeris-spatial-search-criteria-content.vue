...
<span class="error-message" v-if="errorMessage">{{errorMessage}}</span>
  ...
  <div class="aeris-input-group">
    <span class="right">{{$t('northAbbr')}}</span><input class="spatial-search-criteria" name="north"
                                                         @change="handleChange" @input="checkValidity"
                                                         v-model="north"></input>
  </div>

  <div class="aeris-input-group">
    <span class="right">{{$t('eastAbbr')}}</span><input class="spatial-search-criteria" name="east"
                                                        @change="handleChange" @input="checkValidity"
                                                        v-model="east"></input>
  </div>

  <div class="aeris-input-group">
    <span class="right">{{$t('southAbbr')}}</span><input class="spatial-search-criteria" name="south"
                                                         @change="handleChange" @input="checkValidity"
                                                         v-model="south"></input>
  </div>

  <div class="aeris-input-group">
    <span class="right">{{$t('westAbbr')}}</span><input class="spatial-search-criteria" name="west"
                                                        @change="handleChange" @input="checkValidity"
                                                        v-model="west"></input>
  </div>
  </span>
        <div class="map-popup" v-if="showMap">
            <div class="map-popup-title">
                ...
                <div @click="closeMapPopup">
                    <i class="fa fa-times" :title="$t('close')"></i>
                </div>
            </div>
...
<style>
    ...
    [data-aeris-spatial-search-criteria-content] .map-popup .map-popup-title, [data-aeris-spatial-search-criteria-content] .map-popup > .map-popup-title > h3 {
        width: 100%;
        text-align: center;
        margin-top: 4px;
    }
