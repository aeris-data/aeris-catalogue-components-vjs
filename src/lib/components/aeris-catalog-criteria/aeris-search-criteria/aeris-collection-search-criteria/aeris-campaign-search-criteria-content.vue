...
<div data-aeris-collection-search-criteria-content>
  <aeris-tree-checkbox-layout type="collections" name="Campaign" name-subitems="collections"></aeris-tree-checkbox-layout>
</div>
</template>
...
export default {
  ...
  methods: {
    ...
    handleCollectionResponse: function(e) {
      ...
      document.dispatchEvent(new CustomEvent('aerisCampaignItemsEvent', {
        detail: {
