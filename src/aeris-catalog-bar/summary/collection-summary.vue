...
<header class="box-heading" v-on:click="deployed = !deployed">
 ...
 <div id="collapse" class="box-collapsable-part" style="background:green">
  <main class="box-body">
    <div class="content">
    <aeris-international-field :lang="lang" :value="description" max-length="150"></aeris-international-field>
    </div>
  </main>
