<template>
<div>
  <aeris-catalog metadata-service="http://localhost:9080/catalogue/rest/metadatarecette/" criteria-header-icon-color="grey" criteria-background-color="#F5F5F5" criteria-content-primary-color="grey" summary-bar-width="400px" summary-max-length="200" cart-token="aeris" cart-service="https://sedoo.aeris-data.fr/catalogue/rest/shoppingcart">
    <div slot="criteria">
      ...
      <aeris-level-search-criteria></aeris-level-search-criteria>
      <aeris-collection-search-criteria exclusion="CAPITOUL,ESCOMPTE,PASSY" downloadable="EUROCHAMP,GMOS,ACTRIS-FR,GEWEX"></aeris-collection-search-criteria>
