...
export default {
  created() {
    ["aeris-data/actris-catalogue-components-vjs@latest", "aeris-data/actris-metadata-components-vjs@latest"].forEach(
      component => {
        ...
        script.setAttribute(
          "src",
          "https://rawgit.com/aeris-data/aeris-component-loader/master/aerisComponentLoader.js"
        );
